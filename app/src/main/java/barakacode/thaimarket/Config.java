...
public class Config {
    ...
    public static final String HOST = "www.tailandmarket.com";

    public static String HOME_URL = "https://tailandmarket.com/";
    ...
    public static final boolean FALLBACK_USE_LOCAL_HTML_FOLDER_IF_OFFLINE = true;
    ...
    public static String[] ALWAYS_OPEN_IN_INAPP_TAB = new String[]{"https://www.barakacode.store"};
    ...
    public static final boolean FIREBASE_PUSH_ENHANCE_WEBVIEW_URL = true;
